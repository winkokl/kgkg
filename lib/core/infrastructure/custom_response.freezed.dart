...
abstract class $CustomResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool? success, String? status, String? message, dynamic data});
}
...
class _$CustomResponseImpl implements _CustomResponse {
  ...
  @override
  String toString() {
    return 'CustomResponse(success: $success, status: $status, message: $message, data: $data)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$CustomResponseImplToJson(
      this,
    );
  }
}
...
abstract class _CustomResponse implements CustomResponse {
  const factory _CustomResponse(final bool? success, final String? status,
      final String? message, final dynamic data) = _$CustomResponseImpl;
