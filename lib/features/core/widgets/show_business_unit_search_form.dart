...
Future<void> showBusinessUnitSearchForm(BuildContext context, Function(BusinessUnit c) onSelect, [Widget? selectBox, int? id]) async {
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      const Spacer(),
                      const HeaderText("Select BusinessUnits", color: brandColor),
                      const Spacer(),
                      InkWell(
                ...
                const Padding(
                  ...
                  child: SearchTextField(title: 'bn'),
                ),
                const SizedBox(height: 16),
                Expanded(
                  child: Padding(
