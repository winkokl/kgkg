...
class ContractStatusCard extends ConsumerWidget {
  const ContractStatusCard({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final customerTpye = ref.watch(allFiltersProvider.select((value) => value.contractStatus));
    return FilterCard(
        child: Column(
      ...
      children: [
        ...
        Column(
          children: ContractStatus.values
              .where((element) => element.id != ContractStatus.none.id)
              .map((e) => InkWell(
                    onTap: () => ref.read(allFiltersProvider.notifier).setContractStatus(e),
                    child: Padding(
                            ...
                            child: Transform.scale(
                              ...
                              child: Checkbox(
                                ...
                                onChanged: (bool? value) {
                                  ref.read(allFiltersProvider.notifier).setContractStatus(e);
                                },
                              ),
                            ),
                          ),
