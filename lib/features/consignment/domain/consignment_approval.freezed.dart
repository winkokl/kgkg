...
part of 'consignment_approval.dart';
...
mixin _$ConsignmentApproval {
  ...
  @JsonKey(ignore: true)
  $ConsignmentApprovalCopyWith<ConsignmentApproval> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ConsignmentApprovalCopyWith<$Res> {
  factory $ConsignmentApprovalCopyWith(
          ConsignmentApproval value, $Res Function(ConsignmentApproval) then) =
      _$ConsignmentApprovalCopyWithImpl<$Res, ConsignmentApproval>;
  @useResult
  $Res call(
      {int id,
      String code,
...
/// @nodoc
class _$ConsignmentApprovalCopyWithImpl<$Res, $Val extends ConsignmentApproval>
    implements $ConsignmentApprovalCopyWith<$Res> {
  _$ConsignmentApprovalCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ConsignmentApprovalImplCopyWith<$Res>
    implements $ConsignmentApprovalCopyWith<$Res> {
  factory _$$ConsignmentApprovalImplCopyWith(_$ConsignmentApprovalImpl value,
          $Res Function(_$ConsignmentApprovalImpl) then) =
      __$$ConsignmentApprovalImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$ConsignmentApprovalImplCopyWithImpl<$Res>
    extends _$ConsignmentApprovalCopyWithImpl<$Res, _$ConsignmentApprovalImpl>
    implements _$$ConsignmentApprovalImplCopyWith<$Res> {
  __$$ConsignmentApprovalImplCopyWithImpl(_$ConsignmentApprovalImpl _value,
      $Res Function(_$ConsignmentApprovalImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ConsignmentApprovalImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$ConsignmentApprovalImpl implements _ConsignmentApproval {
  const _$ConsignmentApprovalImpl(
      {this.id = -1,
      this.code = "",
      this.date = "",
  ...
  @override
  String toString() {
    return 'ConsignmentApproval(id: $id, code: $code, date: $date, customer: $customer, products: $products, paymentType: $paymentType, paymentTerm: $paymentTerm, remark: $remark, description: $description, deleteReason: $deleteReason, discountAmount: $discountAmount, discountType: $discountType, taxAmount: $taxAmount, taxType: $taxType, otherChargesAmount: $otherChargesAmount, subtotal: $subtotal, grandtotal: $grandtotal, orderStatus: $orderStatus, rejectReason: $rejectReason, businessUnitName: $businessUnitName)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ConsignmentApprovalImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ConsignmentApprovalImplCopyWith<_$ConsignmentApprovalImpl> get copyWith =>
      __$$ConsignmentApprovalImplCopyWithImpl<_$ConsignmentApprovalImpl>(
          this, _$identity);
}

abstract class _ConsignmentApproval implements ConsignmentApproval {
  const factory _ConsignmentApproval(
      {final int id,
      final String code,
      final String date,
      final Customer customer,
      ...
      final OrderStatus orderStatus,
      final String rejectReason,
      final String businessUnitName}) = _$ConsignmentApprovalImpl;
