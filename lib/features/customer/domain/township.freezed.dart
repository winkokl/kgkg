...
class _$TownshipImpl implements _Township {
  const _$TownshipImpl({this.id = -1, this.name = ""});
...
abstract class _Township implements Township {
  const factory _Township({final int id, final String name}) = _$TownshipImpl;
