...
Future<void> showWayCustomerSearchForm(BuildContext context, Function(Customer c) onSelect, [Widget? selectBox, int? id]) async {
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      const Spacer(),
                      const HeaderText("Select Customers", color: brandColor),
                      const Spacer(),
                      InkWell(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: CommonPagingView(
                      provider: paginatedWayCustomerNotifierProvider,
