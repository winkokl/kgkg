...
Future<void> showWaySearchForm(
  BuildContext context,
  Function(Way c) onSelect,
) async {
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      const Spacer(),
                      const HeaderText("Select Way Name", color: brandColor),
                      const Spacer(),
                      InkWell(
                ...
                const Padding(
                  ...
                  child: SearchTextField(title: 'way'),
                ),
                const SizedBox(height: 16),
                Expanded(
                  child: Padding(
                    ...
                    child: CommonPagingView(
                      provider: paginatedWayNotifierProvider,
