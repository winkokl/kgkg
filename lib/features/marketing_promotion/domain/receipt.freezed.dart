...
class _$ReceiptImpl implements _Receipt {
  ...
  @override
  String toString() {
    return 'Receipt(id: $id, code: $code, invoiceCode: $invoiceCode, invoiceId: $invoiceId, customerName: $customerName, businessUnitName: $businessUnitName, paymentReceiveAmount: $paymentReceiveAmount, paymentReciveDate: $paymentReciveDate, balance: $balance, remark: $remark, description: $description, signUrl: $signUrl, paymentMethod: $paymentMethod)';
  }
...
abstract class _Receipt implements Receipt {
  const factory _Receipt(
      ...
      final String description,
      final String signUrl,
      final PaymentMethod paymentMethod}) = _$ReceiptImpl;
