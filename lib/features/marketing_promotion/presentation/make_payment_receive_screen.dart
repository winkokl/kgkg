...
class MakePaymentReceiveScreen extends HookConsumerWidget {
  const MakePaymentReceiveScreen({
    super.key,
              ...
              child: ActionButton(
                  ...
                  onPressed: () {
                    if (formKey.currentState!.validate() == true) {
                      ...
                      ref.read(asyncMarketingPromotionFormNotifierProvider.notifier).makePaymentReceive(
                              // attachment.value,
                              // signature.value!,
                              saleInvoice.copyWith(
                            paidAmt: paidAmountController.text.toDouble(),
                            paymentReceiveDate: paymentReceiveDate.value,
                          ));
                    }
                  }),
            ),
