...
part of 'trip_sale_invoice.dart';
...
mixin _$TripSaleInvoice {
  ...
  List<TripSaleReceipt> get paymentReceivedHistory =>
  ...
  @JsonKey(ignore: true)
  $TripSaleInvoiceCopyWith<TripSaleInvoice> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TripSaleInvoiceCopyWith<$Res> {
  factory $TripSaleInvoiceCopyWith(
          TripSaleInvoice value, $Res Function(TripSaleInvoice) then) =
      _$TripSaleInvoiceCopyWithImpl<$Res, TripSaleInvoice>;
  @useResult
  $Res call(
      {int id,
      int saleOrderId,
      ...
      List<TripSaleReceipt> paymentReceivedHistory,
      int salePromotionId,
...
/// @nodoc
class _$TripSaleInvoiceCopyWithImpl<$Res, $Val extends TripSaleInvoice>
    implements $TripSaleInvoiceCopyWith<$Res> {
  _$TripSaleInvoiceCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$TripSaleInvoiceImplCopyWith<$Res>
    implements $TripSaleInvoiceCopyWith<$Res> {
  factory _$$TripSaleInvoiceImplCopyWith(_$TripSaleInvoiceImpl value,
          $Res Function(_$TripSaleInvoiceImpl) then) =
      __$$TripSaleInvoiceImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$TripSaleInvoiceImplCopyWithImpl<$Res>
    extends _$TripSaleInvoiceCopyWithImpl<$Res, _$TripSaleInvoiceImpl>
    implements _$$TripSaleInvoiceImplCopyWith<$Res> {
  __$$TripSaleInvoiceImplCopyWithImpl(
      _$TripSaleInvoiceImpl _value, $Res Function(_$TripSaleInvoiceImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$TripSaleInvoiceImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$TripSaleInvoiceImpl implements _TripSaleInvoice {
  const _$TripSaleInvoiceImpl(
      {this.id = -1,
      this.saleOrderId = -1,
      this.code = "",
      this.tripSaleId = "",
      ...
      final List<TripSaleReceipt> paymentReceivedHistory = const [],
  ...
  final List<TripSaleReceipt> _paymentReceivedHistory;
  @override
  @JsonKey()
  List<TripSaleReceipt> get paymentReceivedHistory {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$TripSaleInvoiceImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$TripSaleInvoiceImplCopyWith<_$TripSaleInvoiceImpl> get copyWith =>
      __$$TripSaleInvoiceImplCopyWithImpl<_$TripSaleInvoiceImpl>(
          this, _$identity);
}

abstract class _TripSaleInvoice implements TripSaleInvoice {
  const factory _TripSaleInvoice(
      {final int id,
      final int saleOrderId,
      final String code,
      final String tripSaleId,
      ...
      final PaymentStatus paymentStatus,
      final List<TripSaleReceipt> paymentReceivedHistory,
      final int salePromotionId,
      final SalePromotion salePromotion}) = _$TripSaleInvoiceImpl;
