...
class MakeTripSalePaymentReceiveScreen extends HookConsumerWidget {
  const MakeTripSalePaymentReceiveScreen({
    super.key,
    required this.saleInvoice,
  });
  final TripSaleInvoice saleInvoice;
    ...
    ref.listenX(
      ...
      onData: (res) => CustomDialog.showDoneAndPrintDialog(
        ...
        printOnPressed: () async {
          final tripReceipt = res.data as TripSaleReceipt;
          LoadingOverlay.show();
          await PrintServiceV2.excutePayment(
              context,
              PaymentPrintFormat(
                invoiceID: tripReceipt.invoiceCode,
                receiveDate: tripReceipt.paymentReciveDate,
                receiveID: tripReceipt.code,
                paymentAmount: tripReceipt.paymentReceiveAmount,
                    ...
                    if (formKey.currentState!.validate() == true) {
                      ...
                      ref.read(asyncTripSaleFormNotifierProvider.notifier).makePaymentReceive(
                          ...
                          TripSaleReceipt(
                            ...
                            tripSaleInvoiceId: saleInvoice.id,
