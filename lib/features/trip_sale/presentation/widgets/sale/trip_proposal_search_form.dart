...
Future<void> showTripProposalSearchForm(BuildContext context, Function(TripProposal tripProposal) onSelect) async {
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      const Spacer(),
                      const HeaderText("Select Trip Proposal", color: brandColor),
                      const Spacer(),
                      InkWell(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return InkWell(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                HeaderText(data.items[index].tripCode),
                                const SizedBox(height: 16),
