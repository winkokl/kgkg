...
class MarketingPromotionReturnTotalWidget extends HookConsumerWidget {
  const MarketingPromotionReturnTotalWidget({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final returnDeductController = useTextEditingController(text: formatter.format(totalCharges.returnDeductAmount));
