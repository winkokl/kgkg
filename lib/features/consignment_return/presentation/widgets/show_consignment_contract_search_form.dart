...
Future<void> showConsignmentContractSearchForm(BuildContext context, Function(ConsignmentContract saleInvoice) onSelect) async {
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              children: [
                                const Spacer(),
                                const HeaderText("Select Consignment Contract", color: brandColor),
                                const Spacer(),
                                InkWell(
