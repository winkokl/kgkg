...
Future<void> showSalePromotionSearchForm(BuildContext context, Function(SalePromotion c) onSelect) async {
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      const Spacer(),
                      const HeaderText("Select Promotion Name", color: brandColor),
                      const Spacer(),
                      InkWell(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: CommonPagingView(
                      provider: paginatedSalePromotionNotifierProvider,
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return InkWell(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                HeaderText(data.items[index].promotionName),
                                const SizedBox(height: 16),
