...
part 'secondary_sale_return_receipt.freezed.dart';

@freezed
class SecondarySaleReturnReceipt with _$SecondarySaleReturnReceipt implements PagingDataItem {
  const factory SecondarySaleReturnReceipt({
    @Default(-1) int id,
    @Default(-1) int secondarySaleReturnId,
