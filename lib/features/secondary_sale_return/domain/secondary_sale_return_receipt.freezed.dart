...
part of 'secondary_sale_return_receipt.dart';
...
/// @nodoc
mixin _$SecondarySaleReturnReceipt {
  int get id => throw _privateConstructorUsedError;
  int get secondarySaleReturnId => throw _privateConstructorUsedError;
  String get retrunDueDate => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $SecondarySaleReturnReceiptCopyWith<SecondarySaleReturnReceipt>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SecondarySaleReturnReceiptCopyWith<$Res> {
  factory $SecondarySaleReturnReceiptCopyWith(SecondarySaleReturnReceipt value,
          $Res Function(SecondarySaleReturnReceipt) then) =
      _$SecondarySaleReturnReceiptCopyWithImpl<$Res,
          SecondarySaleReturnReceipt>;
  @useResult
  $Res call(
      {int id,
      int secondarySaleReturnId,
      String retrunDueDate,
      String code,
      String paymentDate,
...
/// @nodoc
class _$SecondarySaleReturnReceiptCopyWithImpl<$Res,
        $Val extends SecondarySaleReturnReceipt>
    implements $SecondarySaleReturnReceiptCopyWith<$Res> {
  _$SecondarySaleReturnReceiptCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    Object? id = null,
    Object? secondarySaleReturnId = null,
    Object? retrunDueDate = null,
    Object? code = null,
    ...
    return _then(_value.copyWith(
      id: null == id
          ...
          : id // ignore: cast_nullable_to_non_nullable
              as int,
      secondarySaleReturnId: null == secondarySaleReturnId
          ? _value.secondarySaleReturnId
          : secondarySaleReturnId // ignore: cast_nullable_to_non_nullable
              as int,
      retrunDueDate: null == retrunDueDate
          ? _value.retrunDueDate
          : retrunDueDate // ignore: cast_nullable_to_non_nullable
              as String,
      code: null == code
          ? _value.code
...
/// @nodoc
abstract class _$$SecondarySaleReturnInvoiceImplCopyWith<$Res>
    implements $SecondarySaleReturnReceiptCopyWith<$Res> {
  factory _$$SecondarySaleReturnInvoiceImplCopyWith(
          _$SecondarySaleReturnInvoiceImpl value,
          $Res Function(_$SecondarySaleReturnInvoiceImpl) then) =
      __$$SecondarySaleReturnInvoiceImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$SecondarySaleReturnInvoiceImplCopyWithImpl<$Res>
    extends _$SecondarySaleReturnReceiptCopyWithImpl<$Res,
        _$SecondarySaleReturnInvoiceImpl>
    implements _$$SecondarySaleReturnInvoiceImplCopyWith<$Res> {
  __$$SecondarySaleReturnInvoiceImplCopyWithImpl(
      _$SecondarySaleReturnInvoiceImpl _value,
      $Res Function(_$SecondarySaleReturnInvoiceImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SecondarySaleReturnInvoiceImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$SecondarySaleReturnInvoiceImpl implements _SecondarySaleReturnInvoice {
  const _$SecondarySaleReturnInvoiceImpl(
      {this.id = -1,
      this.secondarySaleReturnId = -1,
      this.retrunDueDate = "",
      this.code = "",
      this.paymentDate = "",
  ...
  @override
  @JsonKey()
  final int secondarySaleReturnId;
  @override
  @JsonKey()
  final String retrunDueDate;
  @override
  @JsonKey()
  final String code;
  @override
  ...
  @override
  String toString() {
    return 'SecondarySaleReturnReceipt(id: $id, secondarySaleReturnId: $secondarySaleReturnId, retrunDueDate: $retrunDueDate, code: $code, paymentDate: $paymentDate, totalInvoiceAmount: $totalInvoiceAmount, balance: $balance, paidAmount: $paidAmount, returnDate: $returnDate, invoiceCode: $invoiceCode, secondarySaleInvoice: $secondarySaleInvoice, customer: $customer, products: $products, remark: $remark, description: $description, deleteReason: $deleteReason, returnDeductAmount: $returnDeductAmount, returnDeductType: $returnDeductType, otherChargesAmount: $otherChargesAmount, subtotal: $subtotal, grandtotal: $grandtotal, totalReturnAmount: $totalReturnAmount, signUrl: $signUrl, paymentMethod: $paymentMethod)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$SecondarySaleReturnInvoiceImpl &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.secondarySaleReturnId, secondarySaleReturnId) ||
                other.secondarySaleReturnId == secondarySaleReturnId) &&
            (identical(other.retrunDueDate, retrunDueDate) ||
                other.retrunDueDate == retrunDueDate) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SecondarySaleReturnInvoiceImplCopyWith<_$SecondarySaleReturnInvoiceImpl>
      get copyWith => __$$SecondarySaleReturnInvoiceImplCopyWithImpl<
          _$SecondarySaleReturnInvoiceImpl>(this, _$identity);
}

abstract class _SecondarySaleReturnInvoice
    implements SecondarySaleReturnReceipt {
  const factory _SecondarySaleReturnInvoice(
      {final int id,
      final int secondarySaleReturnId,
      final String retrunDueDate,
      final String code,
      ...
      final double totalReturnAmount,
      final String signUrl,
      final PaymentMethod paymentMethod}) = _$SecondarySaleReturnInvoiceImpl;

  @override
  int get id;
  @override
  int get secondarySaleReturnId;
  @override
  String get retrunDueDate;
  @override
  String get code;
  @override
