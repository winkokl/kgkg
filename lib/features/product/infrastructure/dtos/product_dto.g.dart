...
_$ProductDTOImpl _$$ProductDTOImplFromJson(Map<String, dynamic> json) => _$ProductDTOImpl(
      id: (json['product_id'] as num?)?.toInt() ?? -1,
      secondarySaleReturnDetailId: (json['secondary_sales_return_detail_id'] as num?)?.toInt(),
      ...
      consignmentContractQty: (json['consignment_contract_qty'] as num?)?.toInt() ?? 0,
      consignmentContractAmount: (json['consignment_contract_amount'] as num?)?.toDouble() ?? 0,
      salePrice: (json['sales_price'] as num?)?.toDouble() ?? 0,
      primarySalePrice: (json['primary_sales_price'] as num?)?.toDouble() ?? 0,
      secondarySalePrice: (json['secondary_sales_price'] as num?)?.toDouble() ?? 0,
      consignmentSalePrice: (json['consignment_sales_price'] as num?)?.toDouble() ?? 0,
      ...
      unitTypeDTOs: (json['unit_type_data'] as List<dynamic>?)?.map((e) => UnitTypeDTO.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
      isPromotionItem: json['is_promotion_item'] == null ? false : _boolfromJson(json['is_promotion_item']),
      salePromotionDetailId: (json['sale_promotion_detail_id'] as num?)?.toInt(),
      promotionDetailDTO: json['is_promotion_item_list'] == null ? null : PromotionDetailDTO.fromJson(json['is_promotion_item_list'] as Map<String, dynamic>),
      itemBackProduct: json['item_back_product'] == null ? null : InfoDTO.fromJson(json['item_back_product'] as Map<String, dynamic>),
      productCodePrefix: json['product_code_prefix'] as String? ?? "",
      availableQtyFromWarehouse: (json['available_quantity'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$$ProductDTOImplToJson(_$ProductDTOImpl instance) {
  ...
  writeNotNull('secondary_sales_return_detail_id', instance.secondarySaleReturnDetailId);
  ...
  // val['sale_promotion_detail_id'] = instance.salePromotionDetailId;
