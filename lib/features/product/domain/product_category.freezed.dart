...
abstract class $ProductCategoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, int consignmentContractId});
}
...
class _$ProductCategoryImpl implements _ProductCategory {
  const _$ProductCategoryImpl(
      {this.id = -1, this.name = "", this.consignmentContractId = -1});
  ...
  @override
  String toString() {
    return 'ProductCategory(id: $id, name: $name, consignmentContractId: $consignmentContractId)';
  }
...
abstract class _ProductCategory implements ProductCategory {
  const factory _ProductCategory(
      {final int id,
      final String name,
      final int consignmentContractId}) = _$ProductCategoryImpl;
