...
Future<void> showTripNameSearchForm(BuildContext context, Function(TripName c) onSelect, [Widget? selectBox, int? id]) async {
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      const Spacer(),
                      const HeaderText("Select Trip Names", color: brandColor),
                      const Spacer(),
                      InkWell(
                ...
                const Padding(
                  ...
                  child: SearchTextField(title: 'tn'),
                ),
                const SizedBox(height: 16),
                Expanded(
                  child: Padding(
                    ...
                    child: CommonPagingView(
                      provider: paginatedTripNameNotifierProvider,
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return InkWell(
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [Expanded(child: HeaderText(data.items[index].name)), if (selectBox != null && id == data.items[index].id) selectBox],
                                ),
                                const SizedBox(height: 16),
